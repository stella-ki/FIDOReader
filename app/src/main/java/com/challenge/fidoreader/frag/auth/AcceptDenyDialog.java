...
public class AcceptDenyDialog extends Dialog {
    ...
    public AcceptDenyDialog(Context context, @StyleRes int themeResId) {
        ...
        mPositiveButton = (ImageButton) findViewById(R.id.mPositiveButton);
        mPositiveButton.setOnClickListener(mButtonHandler);
        mNegativeButton = (ImageButton) findViewById(R.id.mNegativeButton);
     ...
     */
    public void setButton(int whichButton, OnClickListener listener) {
        switch (whichButton) {
            case DialogInterface.BUTTON_POSITIVE:
