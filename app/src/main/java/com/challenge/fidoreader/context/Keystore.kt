...
import com.challenge.fidoreader.context.FUSE_CREATED_PREFERENCE_KEY
...
abstract class Credential {
    ...
    companion object {
        ...
        fun fromKeyHandle(
            ...
            if (keyHandleData.size == 32) {
                Log.e(TAG, "keyhandleData length is 32, than this keyhandle is for U2F")
                return null
            }
            ...
            var credential : Credential = WebAuthnCredential(
                    keyAlias,
                    rpIdHash,
                    rpName
            )
            credential._keyHandle = keyHandle
